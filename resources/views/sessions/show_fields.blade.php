...
<!-- Created At Field -->
<div class="form-group">
    {!! Form::label('created_at', __('models/sessions.fields.created_at').':') !!}
    <p>{{ $session->created_at }}</p>
</div>

<!-- Updated At Field -->
<div class="form-group">
    {!! Form::label('updated_at', __('models/sessions.fields.updated_at').':') !!}
