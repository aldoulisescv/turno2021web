...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-06-2022 a las 21:14:18
...
--
-- Base de datos: `turnoprod`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `blocked_dates`
--
...
--
-- Volcado de datos para la tabla `blocked_dates`
--
...
--
-- Estructura de tabla para la tabla `relation_resource_sessions`
--
...
--
-- Volcado de datos para la tabla `relation_resource_sessions`
--
...
--
-- Estructura de tabla para la tabla `status_turnos`
--
...
--
-- Volcado de datos para la tabla `status_turnos`
--
...
--
-- Indices de la tabla `blocked_dates`
--
...
--
-- Indices de la tabla `relation_resource_sessions`
--
...
--
-- Indices de la tabla `status_turnos`
--
...
--
-- AUTO_INCREMENT de la tabla `blocked_dates`
--
ALTER TABLE `blocked_dates`
...
--
-- AUTO_INCREMENT de la tabla `helps`
--
ALTER TABLE `helps`
...
--
-- AUTO_INCREMENT de la tabla `relation_resource_sessions`
--
ALTER TABLE `relation_resource_sessions`
...
--
-- AUTO_INCREMENT de la tabla `status_turnos`
--
ALTER TABLE `status_turnos`
...
--
-- Filtros para la tabla `relation_resource_sessions`
--
ALTER TABLE `relation_resource_sessions`
